...
public:
    ...
    virtual void draw_board(const class Board& board, int level, GameMode mode) = 0;       // 보드 외곽 + 고정 블록
    ...
    virtual void draw_skill_status(bool q, bool w, bool e, int q_cnt, int w_cnt, int w_tgt) = 0;    // 스킬 보유 여부 출력
